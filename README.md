...
### Aim:
To write the prompt for the following prompt types and compare that with different AI tools and evaluate that using any one evaluation method (Ex. Rubrics). 
...
Task: Explain the concept of Machine Learning to a college student.
...
Unsupervised Learning – The model finds patterns in data without labeled answers. Example: customer segmentation.
Reinforcement Learning – The model learns by interacting with an environment and receiving rewards or penalties. Example: game-playing AI.

Working Process:
Data is collected and prepared before being given to a machine learning algorithm. The algorithm identifies patterns in the training data and creates a model. The model is then tested using new data to make predictions or decisions.
...
Give the AI a few examples before asking the actual question.

Prompt:

Example 1:
Topic: Artificial Intelligence
Explanation: Artificial Intelligence is the ability of machines to perform tasks that normally require human intelligence.
...
Ask the AI to reason through the problem step by step.
...
Assign a role/persona to the AI.
...
Types
Supervised Learning: Learning using labeled examples.
...
Instead of directly giving the complete prompt, ask the AI to determine what information/prompt would be needed to produce the desired answer.
...
Represent the information as relationships between concepts.
...
Machine Learning → Applications → Healthcare, Finance, Education
Machine Learning → Process → Data → Training → Model → Prediction
...
<img width="562" height="287" alt="image" src="https://github.com/user-attachments/assets/b8b18aad-06cb-4a8a-9d9b-512d1e7b2d03" />


Machine Learning → Types

Supervised Learning: Uses labeled data to learn a relationship between inputs and outputs.
Unsupervised Learning: Finds patterns or groups within unlabeled data.
Reinforcement Learning: Learns actions by receiving rewards or penalties.
...
Use an interactive approach where the AI asks for information/clarification before generating the final answer.
...
AI Output – Questions
What is your educational level and how much technical knowledge do you have?
How long should the explanation be?
Would you prefer real-world examples, technical examples, or both?
Student's Response
I am a college student with basic technical knowledge.
I need approximately 300 words.
I prefer both real-world and technical examples.
Final AI Output
...
Supervised Learning: The model learns from labeled data. For example, a system can learn to identify spam emails from previously labeled emails.
Unsupervised Learning: The model finds patterns in data without predefined labels. Customer segmentation is a common example.
Reinforcement Learning: The model learns by receiving rewards or penalties for its actions. Game-playing systems are an example.
...
The experiment was successfully performed using Zero-shot, Few-shot, Chain-of-Thought, Persona, Reverse, Graph, and Active Prompting techniques. The experiment demonstrated that the structure and context provided in a prompt significantly influence the quality, relevance, clarity, and detail of the generated response. Different prompting techniques are useful for different types of tasks.
